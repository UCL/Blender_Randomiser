...
geom_out_dict = out_data["materials"]
...
counter = 0
all_geom_dict["min"] = 0.1
all_geom_dict["max"] = 0.9
for gng_idx in range(len(cs.socket_props_per_material.collection)):
    # for gng in cs.socket_props_per_gng.collection:

    # get this subpanel's GNG
    subpanel_gng = cs.socket_props_per_material.collection[gng_idx]
    ...
    print("TEST Collection of MAT Node Groups updated")
...
# socket_props_per_gng.collection[0].collection[
###    0
###].max_float_1d[0]
