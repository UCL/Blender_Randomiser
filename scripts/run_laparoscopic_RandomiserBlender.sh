...
if ( [[ ${correct_input} -eq 0 ]] ) ; then
  ...
  echo ""
  echo "${script_name} -blend /home/username/file.blend -json_in /home/username/input.json -json_out  /home/username/output.json -json /home/username/synb0/dwi.json -seed 32 -frame 10 -basename /home/username/output_frame"
  echo ""
  exit
fi
...
blender -b ${blend_file} --python install_and_enable_addons_render_laparoscopic.py -- ../randomiser.zip --seed ${seed_num} --input ${json_input} --frame ${frame} --basename ${base_output}