...
${blender} -b ${blend_file} --python ${script_path}/install_and_enable_addons.py -- ${script_path}/randomiser.zip --seed ${seed_num} --input ${json_input} --frame ${frame} --basename ${base_output}
